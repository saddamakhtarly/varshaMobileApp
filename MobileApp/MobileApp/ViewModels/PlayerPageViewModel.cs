...
{
  public  class PlayerPageViewModel:NotifyModel
    {
        public INavigation Navigation { get; set; }

        public PlayerPageViewModel(INavigation navigation,Music music,List<Music> musicList)
        {
            Navigation = navigation;
            selectedMusic = music;
            MusicList = new ObservableCollection<Music>(musicList as List<Music>); ;
       ...
       // public ICommand ShareCommand => new Command(() => Share.RequestAsync(selectedMusic.Url, selectedMusic.MusicName));
        ...
        {
            var mediaInfo = MediaManager.CrossMediaManager.Current;
